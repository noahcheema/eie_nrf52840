...
int main(void) {
  ...
  int bluetooth = bt_enable(NULL);
  if(bluetooth){
    printk("Bluetooth not werking.\n");
  }
  else{
    printk("Bluetooth initialized\n");
  }

  bluetooth = bt_le_adv_start(BT_LE_ADV_CONN_FAST_1, ble_advertising_data, ARRAY_SIZE(ble_advertising_data), NULL, 0);
